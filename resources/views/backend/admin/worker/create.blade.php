		...
		<div class="col-xs-12 col-sm-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Worker Entry</h4>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.worker.store')}}" method="post" class="form-horizontal" role="form" >
							@csrf
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Name </label>
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="name" value="{{old('name')}}" placeholder="Worker Name" class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="address" value="{{old('address')}}" placeholder="Worker Address" class="col-sm-8">
