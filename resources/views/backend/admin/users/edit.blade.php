	...
	@can('user-edit')
		<div class="col-xs-12 col-sm-5">
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						{!! Form::model($user, ['method' => 'PATCH','route' => ['admin.users.update', $user->id],'class'=>'form-horizontal form-label-left']) !!}
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Full Name <span class="required">*</span></label>
								<div class="col-md-8 col-sm-8 col-xs-12">
									<input type="text" id="first-name" name="name" value="{{old('name') ?? $user->name}}" required="required" class="form-control col-md-7 col-xs-12" placeholder="User Full Name">
							...
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="last-name">Email<span class="required">*</span></label>
									<div class="col-md-8 col-sm-8 col-xs-12">
									<input type="email" id="last-name" name="email" value="{{old('email') ?? $user->email}}"  required="required" class="form-control col-md-7 col-xs-12" placeholder="User Email">
							...
							<div class="form-group">
								<label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">Role</label>
									...
									<p class="error-sms">{{ $errors->first('roles') }}</p>
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">
								 <a href="{{route('admin.users.index')}}" class="btn btn-xs btn-danger">Cancel</a>
