			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.expense_type.store')}}" method="post" class="form-horizontal" role="form" >
							@csrf
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Category Name </label>
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="type_name" value="{{old('type_name')}}" placeholder="Category Name" class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="description" value="{{old('description')}}" placeholder="Category Name" class="col-sm-8">
