						...
						<div class="widget-box transparent">
							<div class="widget-header widget-header-large">
								<h3 class="widget-title grey lighter">
									...
									<a href="{{ route('admin.worker_order.index')}}" calss="btn" ><i class="fa fa-mail-reply"></i></a>
									Order Information
								</h3>
								...
								<div class="widget-main padding-24">
									<div class="row">
										<div class="col-sm-6 col-xs-6">
											...
											<div>
												<ul class="list-unstyled spaced">
													...
													<li><i class="ace-icon fa fa-caret-right blue"></i><b>Total Wage:</b> {{$order->total_wage }}</li>
													<li><i class="ace-icon fa fa-caret-right blue"></i><b>Per Gram Wage:</b> {{$order->per_gram_wage }}</li>
										...
										<div class="col-sm-6 col-xs-6">
											...
											<div>
												<ul class="list-unstyled  spaced">
													<li><i class="ace-icon fa fa-caret-right green"></i><b>Name:</b> {{$order->worker->name}}</li>
													<li><i class="ace-icon fa fa-caret-right green"></i><b>Phone:</b> {{$order->worker->phone}}</li>
													<li><i class="ace-icon fa fa-caret-right green"></i><b>Address:</b> {{$order->worker->address}}</li>
												</ul>
											</div>
										</div><!-- /.col -->
									</div><!-- /.row -->
