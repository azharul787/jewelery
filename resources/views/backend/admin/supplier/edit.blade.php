		...
		<div class="col-xs-12 col-sm-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Supplier Edit</h4>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.supplier.update',$supplier->id)}}" method="post" class="form-horizontal" role="form" >
							@csrf
							@method('put')
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Name </label>
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="supplier_name" value="{{old('supplier_name') ?? $supplier->supplier_name}}" placeholder="Supplier Name" class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="phone" value="{{old('phone') ?? $supplier->phone}}" placeholder="01xxxxxxxxx" class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="email" value="{{old('email') ?? $supplier->email}}" placeholder="Email Address" class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="address" value="{{old('address') ?? $supplier->address}}" placeholder="Supplier Address" class="col-sm-8">
