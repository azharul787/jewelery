...
@section('title', 'Wastage Report List')
		...
		<div class="col-xs-12 col-sm-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title"> Wastage Return Report Product Wise</h4>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form id="demo-form2" action="{{ route('admin.report.wrs')}}" method="post" data-parsley-validate class="form" enctype="multipart/form-data" >
							@csrf
							@method('PUT')
							<div class="row">
											...
											<table class="table table-condensed table-bordered">
												...
												@foreach($purchases as $key=>$pur)
													@php
														...
														$quantity = $quantity + $pur->return_quantity;
													@endphp
													<tr>
														<td>{{ $key + 1}}</td>
