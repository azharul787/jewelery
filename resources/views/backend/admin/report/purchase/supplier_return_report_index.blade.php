...
@section('title', 'Supplier Report List')
		...
		<div class="col-xs-12 col-sm-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title"> Purchase Report Supplier Wise</h4>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form id="demo-form2" action="{{ route('admin.report.sprs')}}" method="post" data-parsley-validate class="form" enctype="multipart/form-data" >
							@csrf
							@method('PUT')
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<select name="supplier_id" id="supplier_id" class="form-control select2">
											...
											@foreach($suppliers as $pr)
												<option value="{{ $pr->supplier_id}}">{{ $pr->supplier_name}} </option>
											@endforeach
										</select>
									</div>
								</div>
											...
											<div class="row">
												...
												<div class="col-xs-8">
													<div class="text-center">
														...
														<h5>Supplier Wise Purchase Return Report</h5>
														<p>Product Type: {{$ty}}</p>
