		...
		<div class="col-xs-12 col-sm-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title"> Sale Report Product Wise</h4>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form id="demo-form2" action="{{ route('admin.report.psrs')}}" method="post" data-parsley-validate class="form" enctype="multipart/form-data" >
							@csrf
							@method('PUT')
							<div class="row">
											...
											<div class="row">
												...
												<div class="col-xs-8">
													<div class="text-center">
														...
														<h5>Sale Return Report Product Wise</h5>
														<p>Product Type: {{$ty}}</p>
