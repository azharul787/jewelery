		...
		<div class="col-xs-12 col-sm-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title"> <a href="{{ route('admin.purchase_return.index')}}" calss="btn" ><i class="fa fa-mail-reply"></i></a> Purchase Return List</h4>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.purchase_return.store')}}" method="post" class="form-horizontal" role="form" >
							@csrf
								<div class="row">
                                    <div class="col-sm-4">
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Supplier Name *</label>
											<div class="col-sm-8">
												<input type="hidden" name="supplier_id" value="{{$pd->supplier_id}}"> 
												<input type="text" class="form-control" name="supplier_name" value="{{$pd->supplier->supplier_name}}" readonly> 
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" name="phone" value="{{$pd->supplier->phone}}" readonly> 
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" name="supplier_address" value="{{$pd->supplier->address}}" readonly> 
												<p class="error-sms">{{ $errors->first('supplier_address') }}</p>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Chalan No *</label>
											<div class="col-sm-8">
												<input type="text" name="chalan_no"  class="form-control" value="{{old('chalan_no') ?? $pd->chalan_no}}" placeholder="Chalan No" readonly>
                                    ...
                                    <div class="col-sm-4">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input id="datepicker" type="text" name="return_date"  class="form-control" data-zdp_readonly_element="true" value="{{ date('d-m-Y',strtotime($pd->purchase_date))}}" placeholder="dd-mm-yyyy" readonly="">
                                ...
                                <table class="table table-striped table-bordered table-hover table-header-fixed dt-responsive green" id="sale">
                                    <thead class="info">
                                        <tr>
                                            ...
                                            <th class="all">P.Qty</th>
                                            <th class="all">N.Stock</th>
                                    ...
                                    <tbody>
                                    	@foreach($pd->details as $key=>$pur)
                                    		<tr id="{{$pur->id}}">
                                    			<td>{{$key + 1}}</td>
                                    			<td>
                                    				<input type='hidden' name="product_id[]" value="{{$pur->product_id}}"> 
                                    				<input type='hidden' name="purchase_detail_id[]" value="{{$pur->id}}"> 
                                    				...
                                    				<input type='hidden' name="model_no[]" value="{{$pur->model_no}}"> 
                                    				<input type='hidden' name="purchase_price[]" value="{{$pur->purchase_price}}"> 
                                    			...
                                    			<td>{{$pur->model_no}}</td>
                                    			<td>{{$pur->quantity}}</td>
                                    			<td  id='{{$pur->id}}_stock'>{{$pur->now_stock}}</td>
                                    			<td><input type="text" name="return_quantity[]" id='{{$pur->id}}_ordered_quantity' class='ordered_quantity' {{$pur->now_stock == 0 ? 'readonly' : ''}} size="10"></td>
                                    			<td><input type="text" name="return_price[]" id='{{$pur->id}}_price' class='price' size="10" value="{{$pur->purchase_price}}"></td>
