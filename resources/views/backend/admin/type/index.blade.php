...
@section('content')
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Type Entry</h4>
					<span class="widget-toolbar">
						<a href="#" data-action="settings">
							<i class="ace-icon fa fa-cog"></i>
						</a>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.type.store')}}" method="post" class="form-horizontal" role="form" >
							@csrf
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1-1"> Type Name </label>
								<div class="col-sm-8">
									<input type="text" id="form-field-1-1" name="type_name" value="{{old('type_name')}}" placeholder="Type Name" class="form-control">
