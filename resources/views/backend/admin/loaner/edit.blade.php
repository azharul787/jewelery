		...
		<div class="col-xs-12 col-sm-10">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Loaner Entry</h4>
					...
					<div class="widget-main">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-9">
								<form action="{{route('admin.loaner.update',$loaner->id)}}" method="post" class="form-horizontal" role="form" >
									@csrf
									@method('PUT')
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Name </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" name="name" value="{{old('name') ?? $loaner->loaner_name}}" placeholder="Loaner Name" class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" name="phone" value="{{old('phone') ?? $loaner->loaner_phone}}" placeholder="01xxxxxxxxx" class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" name="address" value="{{old('address') ?? $loaner->loaner_address}}" placeholder="Supplier Address" class="col-sm-8">
