...
@section('content')
	...
	<div class="row">
		<div class="col-xs-12 col-sm-7">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title"> <a href="{{ route('admin.brand.index')}}" calss="btn" ><i class="fa fa-mail-reply"></i></a> Brand List</h4>
		...
		<div class="col-xs-12 col-sm-5">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Brand Edit</h4>
					<span class="widget-toolbar">
						<a href="#" data-action="settings">
							<i class="ace-icon fa fa-cog"></i>
						</a>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.brand.update',$brand->id)}}" method="post" class="form-horizontal" role="form" >
							@csrf
							@method('put')
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right" for="form-field-1-1"> Brand Name </label>
								<div class="col-sm-8">
									<input type="text" id="form-field-1-1" name="brand_name" value="{{old('brand_name') ?? $brand->brand_name}}" placeholder="Brand Name" class="form-control">
