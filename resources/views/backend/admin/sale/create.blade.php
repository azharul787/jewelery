			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.sale.store')}}" method="post" class="form-" role="form" >
							@csrf
							<div class="row">
								<div class="col-sm-3">	
							...
							<div class="row">	
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
										...
										<div class="form-group">
											<label class="control-label col-sm-4">Payment By</label>
											<div class="col-sm-8 "> 
												<select class="form-control select2" id="payment_by" name="payment_by">
												 ...
												 <p class="error-sms">{{ $errors->first('payment_by') }}</p>
											</div>    
										</div>
										<div class="form-group" id="transaction_group" style="display: none">
											<label class="control-label col-sm-4">Transaction No</label>
											<div class="col-md-8">
												<input type="number" class="form-control" id="transaction_no" min="0" name="transaction_no" placeholder="xxxxxxxxxx">
												<p class="error-sms">{{ $errors->first('transaction_no') }}</p>
											</div>  
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="number" class="form-control" id="payment" min="0" name="payment" placeholder="0.00" required>
