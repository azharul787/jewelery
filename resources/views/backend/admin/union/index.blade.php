...
@section('content')
	...
	<div class="row">
		<div class="col-xs-8 col-sm-8">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Union List</h4>
		...
		<div class="col-xs-4 col-sm-4">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Union Entry</h4>
					<span class="widget-toolbar">
						<a href="#" data-action="settings">
							<i class="ace-icon fa fa-cog"></i>
						</a>
					...
					<div class="widget-main">
						<form action="{{route('admin.union.store')}}" method="post" class="form-horizontal" role="form" >
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" id="form-field-1-1" name="union_name" value="{{old('union_name')}}" placeholder="Union Name" class="form-control">
