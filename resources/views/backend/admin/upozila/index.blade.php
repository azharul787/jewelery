...
@section('content')
	...
	<div class="row">
		<div class="col-xs-12 col-sm-7">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Upozila List</h4>
		...
		<div class="col-xs-12 col-sm-5">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Upozila Entry</h4>
					<span class="widget-toolbar">
						<a href="#" data-action="settings">
							<i class="ace-icon fa fa-cog"></i>
						</a>
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.upozila.store')}}" method="post" class="form-horizontal" role="form" >
							@csrf
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" id="form-field-1-1" name="upozila_name" value="{{old('upozila_name')}}" placeholder="Upozila Name" class="form-control">
