		...
		<div class="col-xs-12 col-sm-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title"> <a href="{{ route('admin.worker_order.index')}}" calss="btn" ><i class="fa fa-mail-reply"></i></a> Purchase Return List</h4>
						...
						<form action="{{route('admin.purchase_return.store')}}" method="post" class="form-horizontal" role="form" >
							@csrf
								<div class="row">
                                    <div class="col-sm-4">
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Worker Name *</label>
											<div class="col-sm-8">
												<input type="hidden" name="worker_id" value="{{$pd->worker_id}}"> 
												<input type="text" class="form-control" name="worker_name" value="{{$pd->worker->worker_name}}" readonly> 
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" name="phone" value="{{$pd->worker->phone}}" readonly> 
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" name="worker_address" value="{{$pd->worker->address}}" readonly> 
												<p class="error-sms">{{ $errors->first('worker_address') }}</p>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="form-field-1">Order No *</label>
											<div class="col-sm-8">
												<input type="text" name="chalan_no"  class="form-control" value="{{old('order_no') ?? $pd->order_no}}" placeholder="Chalan No" readonly>
                                    ...
                                    <div class="col-sm-4">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input id="datepicker" type="text" name="return_date"  class="form-control" data-zdp_readonly_element="true" value="{{ date('d-m-Y',strtotime($pd->order_date))}}" placeholder="dd-mm-yyyy" readonly="">
                                    ...
                                    <tbody>
                                    	@foreach($pd->details as $key=>$pur)
                                    		<tr id="{{$pur->id}}">
                                    			...
                                    			<td>{{$pur->type->type_name}}</td>
                                    			<td>{{$pur->weight}}</td>
                                    			<td  id='{{$pur->id}}_stock'>{{$pur->wage}}</td>
