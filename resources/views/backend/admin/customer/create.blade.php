			...
			<div class="widget-box">
				...
				<div class="widget-body">
					<div class="widget-main">
						<form action="{{route('admin.customer.store')}}" method="post" class="form-horizontal" role="form" >
							@csrf
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">  Name </label>
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="customer_name" value="{{old('customer_name')}}" placeholder="Customer Name" class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="customer_phone" value="{{old('customer_phone')}}" placeholder="01xxxxxxxxx" class="col-sm-8">
								...
								<div class="col-sm-9">
									<select class="col-sm-8 select2 " name="distric_name" id="distric_id">
										...
										@foreach($districs as $dis)
											<option value="{{$dis->id}}" {{$dis->id == old('distric_name') ? 'selected' : ''}}>{{$dis->distric_name}}</option>
										@endforeach
									</select>  
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1-1" name="customer_address" value="{{old('customer_address')}}" placeholder="Customer Address" class="col-sm-8">
